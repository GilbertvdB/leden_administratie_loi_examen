 		...
 		<div class="ml-1">
            <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
 			...
 			<ul>
 				...
 				@endcan
 				<li><a href="{{ route('dashboard') }}" class="block hover:text-sky-500 hover:bg-gray-100 py-1 pl-6 active:bg-gray-200 {{ (request()->routeIs('familie.index')) ? 'text-sky-500' : '' }}" >Zoeken</a></li>
 			</ul>
 			</li></details
